    ...
    return (
        <div>
            ...
            backgroundImage: "url(https://i.ibb.co/THCMt5k/Rectangle-1.png)",
                    ...
                    <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                        ...
                        <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
                            <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                                ...
                                <li>
                                    <a href="/course" className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Course</a>
                                </li>
                                <li>
                    ...
                    <div>
                        <h1 className="text-3xl">There is always <br /> something new for <br /> us to learn</h1>
                        ...
                        <img src="https://i.ibb.co/cFkghkR/Vector-2.png" alt="" />
                        <img src="https://i.ibb.co/BTr7z06/Vector-3.png" alt="" />
                        <img src="https://i.ibb.co/BTPbQn4/Vector-5.png" alt="" />
                        </div>
                    </div>
                </nav>
